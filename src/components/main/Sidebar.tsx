...
import Profile from "components/main/modal/Profile.tsx";
      ...
      <div>
        {sidebarOpen ? (
          <div
            ...
            ${player?.activeTrack ? 'h-[calc(100vh-118px)] rounded-br-[14px]' : 'h-screen'} overflow-y-scroll lg:overflow-y-auto no-scrollbar w-[252px] lg:w-[252px] lg:sidebar-expanded:!w-[252px] 2xl:!w-[252px]
          ...
          >
            <div className="flex flex-col justify-between gap-2 pt-[11px] pl-[12px] pb-[15px]">
              ...
              >
                <img src="/assets/Logo.png" alt="Logo" className="w-[67px] h-[54px]"/>
            ...
            <ul className="mt-3 ml-[34px]">
              ...
              <li className="py-2 rounded-sm mb-0.5 last:mb-0 mt-[40px]">
                <button
                    onClick={() => openModal('Profile', <Profile onClose={closeModal}/>)}
                  className="w-full text-left block text-black truncate transition duration-150">
                  <div className="flex items-center">
                    <div className="w-[34px] h-[34px]">{modalState?.type === 'Profile' ? <UserF /> : <User />}</div>
          ...
          <div
            ...
            shrink-0 bg-black transition-all duration-200 ease-in-out ${player?.activeTrack ? 'h-[calc(100vh-118px)] rounded-br-[14px]' : 'h-screen'}`}
          >
            <div className="flex flex-col justify-between gap-2 pt-[11px] pl-[12px] pb-[15px]">
              <button
                ref={trigger}
