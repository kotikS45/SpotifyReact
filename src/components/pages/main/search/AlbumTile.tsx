...
const AlbumTile: React.FC<IAlbumTileProps> = ({ album }) => {
    ...
    return (
        <div className="flex flex-col cursor-pointer w-[180px]" onClick={handleClick}>
            <img src={imageSrc.concat(album.image)} alt={album.name} className="object-cover mx-auto rounded-[16px] w-[180px] h-[180px]"/>
